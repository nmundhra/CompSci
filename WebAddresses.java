...
public class WebAddresses
{
	public static void main(String[] args) throws Exception
	{
		...
		Address fou = new Address();
		fou.street = fin.nextLine();
		fou.city   = fin.nextLine();
		fou.state  = fin.next();
		fou.zip    = fin.nextInt();
		fin.skip("\n");
		
		Address fiv = new Address();
		fiv.street = fin.nextLine();
		fiv.city   = fin.nextLine();
		fiv.state  = fin.next();
		fiv.zip    = fin.nextInt();
		fin.skip("\n");
		...
		System.out.println(fou.street + ", " + fou.city + ", " + fou.state + "  " + fou.zip);
		System.out.println(fiv.street + ", " + fiv.city + ", " + fiv.state + "  " + fiv.zip);
	}
}
