 ...
 * PictureMenu.java
 * 
 * In this program, you'll see how to call functions. 
 * Functions are chunks of code with a name, and "calling" a function means to call on the function to do a task for you.
 */
